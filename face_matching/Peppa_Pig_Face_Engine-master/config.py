...
config.DETECT = edict()
config.DETECT.model_path='Peppa_Pig_Face_Engine-master/model/detector'         ### saved_model or tflite
config.DETECT.topk=10                               ### max boxes
config.DETECT.min_face=1600                         ### max boxes
config.DETECT.thres=0.8                             ### thres for nms
config.DETECT.iou_thres=0.6                         ### iou thres for nms
config.DETECT.input_shape=(256,320,3)               ### input shape for detector


config.KEYPOINTS = edict()
config.KEYPOINTS.model_path='Peppa_Pig_Face_Engine-master/model/keypoints'     ### saved_model or tflite
